...
namespace Easemob.Restfull4Net.Utility.HttpUtility
{
    ...
    public static class Put
    {
        ...
        public static T PutGetJson<T>(string url, CookieContainer cookieContainer = null, Dictionary<string, object> postDataDictionary = null, Dictionary<string, string> fileDictionary = null, string refererUrl = null, Encoding encoding = null, int? timeOut = null, int? maxJsonLength = null, bool isDebug = false, ContentType? contentType = null, Dictionary<string, string> headerDictionary = null,ContentType? accept = null) where T : BaseResponse, new()
        {
            using (MemoryStream ms = new MemoryStream())
            {
                try
                {
                    ...
                    string returnText = RequestUtility.HttpPost(url, cookieContainer, ms, fileDictionary, refererUrl, encoding, timeOut, contentType, headerDictionary,HttpMethod.Put,accept);
                    LogTraceHelper.SendLog(string.Format("Method:PUT\r\n\tParames:{0}\r\n\tReturnText:{1}\r\n\tStatusCode:{2}", postDataDictionary.GetQueryJsonString(), returnText, 200), url, isDebug: isDebug);//记录日志
        ...
        /// <param name="accept">Accept</param>
        public static T PutGetJson<T>(string url, CookieContainer cookieContainer = null, Stream postStream = null, Dictionary<string, string> fileDictionary = null, string refererUrl = null, Encoding encoding = null, int? timeOut = null, int? maxJsonLength = null, bool isDebug = false, ContentType? contentType = null, Dictionary<string, string> headerDictionary = null, ContentType? accept = null) where T : BaseResponse, new()
        {
            try
            {
                string returnText = RequestUtility.HttpPost(url, cookieContainer, postStream, fileDictionary, refererUrl, encoding, timeOut, contentType, headerDictionary, HttpMethod.Put,accept);
        ...
        /// <param name="headerDictionary">自定义请求头参数</param>
        /// <param name="accept">Accept</param>
        public static T PutGetJson<T>(string url, CookieContainer cookieContainer = null, Dictionary<string, object> formData = null, string refererUrl = null, Encoding encoding = null, int? timeOut = null, int? maxJsonLength = null, bool isDebug = false, ContentType? contentType = null, Dictionary<string, string> headerDictionary = null, ContentType? accept = null) where T : BaseResponse, new()
        {
            try
            {
                string returnText = RequestUtility.HttpPost(url, cookieContainer, formData, refererUrl, encoding, timeOut, contentType, headerDictionary, HttpMethod.Put,accept);
        ...
        /// <param name="headerDictionary">自定义请求头参数</param>
        /// <param name="accept">Accept</param>
        public static T PutGetJson<T, T2>(string url, CookieContainer cookieContainer = null, IList<T2> formData = null, string refererUrl = null, Encoding encoding = null, int? timeOut = null, int? maxJsonLength = null, bool isDebug = false, ContentType? contentType = null, Dictionary<string, string> headerDictionary = null, ContentType? accept = null) where T : BaseResponse, new()
        {
            using (MemoryStream ms = new MemoryStream())
            {
                try
                {
                    ...
                    string returnText = RequestUtility.HttpPost(url, cookieContainer, ms, null, refererUrl, encoding, timeOut, contentType, headerDictionary, HttpMethod.Put,accept);
                    LogTraceHelper.SendLog(string.Format("Method:PUT\r\n\tParames:{0}\r\n\tReturnText:{1}\r\n\tStatusCode:{2}", formData.GetQueryJsonString(), returnText, 200), url, isDebug: isDebug); //记录日志
                    var result = SerializerUtility.GetResult<T>(returnText, maxJsonLength: maxJsonLength);
                    return result;
                }
        ...
        public static void FillDownload(string url, string data, Stream stream, ContentType? contentType = null, bool isDebug = false, Dictionary<string, string> headerDictionary = null, ContentType? accept = null)
        {
            try
            {
                ...
                var file = wc.UploadData(url, "PUT", Encoding.UTF8.GetBytes(string.IsNullOrEmpty(data) ? "" : data));
